...
<div class="postList">
    ...
    <button type="button" class="btn btn-outline-primary float-right"><span id="<?php echo $postID; ?>" class="show_more" title="Load more posts">Show more</span></button>
    <span class="loding" style="display: none;"><span class="loding_txt float-right">Loading...</span></span>
    </div>
    <?php } ?>
</div>
</body>
