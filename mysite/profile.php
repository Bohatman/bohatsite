...
require 'config.php';
    ...
    $row = $query->fetch_assoc();
            ...
            $lang = $row['lang'];
            $skill = $row['skill'];
            echo '<p><font color="#C0C0C0">ชื่อ </font>'.$fname.'<font color="#C0C0C0"> นามสกุล </font>'.$lname.'<font color="#C0C0C0"> เพศ </font>'.$sex.'<font color="#C0C0C0"> อายุ </font>'.$AGE.'<font color="#C0C0C0"> จังหวัด </font>'.$city.'</p>';
